...
<Staff src="tentyo.jpg" name="あんころもち" p="店長（看板犬）" dis="食べるか寝るかのどっちかの店長。運よくMIOの目にとまり店長にまで就任したラッキーコーギー。※店鋪出勤はしません"/>
<Staff src="hukutentyo.jpg" name="よもぎもち" p="副店長（クラッシャー）" dis="イタズラすることが生き甲斐。何度怒られてもやめられない。※店鋪出勤はしません"/>
    </div>
    <SalonFooter />
  </>
  )
